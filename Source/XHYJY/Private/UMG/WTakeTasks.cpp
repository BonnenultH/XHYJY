...
void UWTakeTasks::OnSelectedSatellite()
{
	...
	if(CurButton)
	{
		...
		CurButton = Button_Satellite;
		CurButton->SetIsEnabled(false);

	if(Cur2Button)
	{
		Cur2Button->SetIsEnabled(true);
		Cur2Button = nullptr;
	}
	...
	if(CurButton == Button_Satellite)
	{
		...
		if(Cur2Button)
		{
			Cur2Button->SetIsEnabled(true);
      		...
      		Cur2Button = Button_Navigation;
			Cur2Button->SetIsEnabled(false);
	}
...
void UWTakeTasks::OnSelectedCommunication()
{
	...
	if(CurButton == Button_Satellite)
	{
		...
		Cur2Button = Button_Communication;
		Cur2Button->SetIsEnabled(false);
	}
...
void UWTakeTasks::OnSelectedRemoteSensing()
{
	...
	if(CurButton == Button_Satellite)
	{
		...
		Cur2Button = Button_RemoteSensing;
		Cur2Button->SetIsEnabled(false);
	}
...
void UWTakeTasks::OnSelectedScientificExploration()
{
	...
	if(CurButton == Button_Satellite)
	{
		...
		Cur2Button = Button_ScientificExploration;
		Cur2Button->SetIsEnabled(false);
	}
...
void UWTakeTasks::OnSelectedDeepSpaceProbes()
{
	...
	if(Cur2Button)
	{
		...
		CurButton = Button_DeepSpaceProbes;
		CurButton->SetIsEnabled(false);
