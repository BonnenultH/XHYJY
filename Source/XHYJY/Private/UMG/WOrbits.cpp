...
{
	OrbitInfoFunc(EOrbit::EO_LEO, LEO);
	
}

void UWOrbits::MEOClicked()
{
	OrbitInfoFunc(EOrbit::EO_MEO, MEO);
}

void UWOrbits::SSOClicked()
{
	OrbitInfoFunc(EOrbit::EO_SSO, SSO);
}

void UWOrbits::GEOClicked()
{
	OrbitInfoFunc(EOrbit::EO_GEO, GEO);
}

void UWOrbits::GTOClicked()
{
	OrbitInfoFunc(EOrbit::EO_GTO, GTO);
}

void UWOrbits::IGSOClicked()
{
	OrbitInfoFunc(EOrbit::EO_IGSO, IGSO);
}

void UWOrbits::TLIClicked()
{
	OrbitInfoFunc(EOrbit::EO_TLI, TLI);
}

void UWOrbits::TMIClicked()
{
	OrbitInfoFunc(EOrbit::EO_TMI, TMI);
}
