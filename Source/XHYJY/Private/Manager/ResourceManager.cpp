...
AResourceManager::AResourceManager()
{
	...
	ConstructorHelpers::FObjectFinder<USoundWave> LeftRightObj(TEXT("'/Game/Sound/leftandright.leftandright'"));
	LeftRight = LeftRightObj.Object;

	ConstructorHelpers::FObjectFinder<USoundWave> UpDownObj(TEXT("7'/Game/Sound/upanddown.upanddown'"));
	UpDown = UpDownObj.Object;
	...
	ConstructorHelpers::FObjectFinder<USoundWave> HoistUpObj(TEXT("'/Game/Sound/HoistUp.HoistUp'"));
	HoistUp= HoistUpObj.Object;

	ConstructorHelpers::FObjectFinder<USoundWave> RocketConnectionObj(TEXT("'/Game/Sound/RocketConnection.RocketConnection'"));
	RocketConnection= RocketConnectionObj.Object;
