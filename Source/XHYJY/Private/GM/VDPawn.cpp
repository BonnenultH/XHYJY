...
void AVDPawn::BeginPlay()
{
	...
	LeftRight = UGameplayStatics::CreateSound2D(this, ResourceManager->LeftRight,1,1,0,nullptr,false,false);
	UpDown = UGameplayStatics::CreateSound2D(this, ResourceManager->UpDown,1,1,0,nullptr,false,false);
}
...
void AVDPawn::Move(const FInputActionValue& Value)
{
	...
	if((MovementVector.Y != 0 || MovementVector.X != 0 ) && !LeftRight->IsPlaying())
	{
		LeftRight->Play();
	}
	if(MovementVector.Z != 0 && !UpDown->IsPlaying())
	{
		UpDown->Play();
	}
