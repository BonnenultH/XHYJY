...
void AA_CZ3C::BeginPlay()
{
	...
	CoreOneStageC->SetCollisionEnabled(ECollisionEnabled::Type::NoCollision);
	RollBooster1C->SetCollisionEnabled(ECollisionEnabled::Type::NoCollision);
	RollBooster2C->SetCollisionEnabled(ECollisionEnabled::Type::NoCollision);
	CowlingC->SetCollisionEnabled(ECollisionEnabled::Type::NoCollision);
	CoreThreeStageC->SetCollisionEnabled(ECollisionEnabled::Type::NoCollision);
	CoreTwoStageC->SetCollisionEnabled(ECollisionEnabled::Type::NoCollision);
}
